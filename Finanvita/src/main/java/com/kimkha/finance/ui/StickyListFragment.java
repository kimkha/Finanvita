...
import com.kimkha.finance.adapters.AbstractStickyCursorAdapter;
...
public abstract class StickyListFragment extends BaseFragment implements AdapterView.OnItemClickListener, LoaderManager.LoaderCallbacks<Cursor>
{
    public static final String RESULT_EXTRA_ITEM_ID = StickyListFragment.class.getName() + ".RESULT_EXTRA_ITEM_ID";
    public static final String RESULT_EXTRA_ITEM_IDS = StickyListFragment.class.getName() + ".RESULT_EXTRA_ITEM_IDS";
    // -----------------------------------------------------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------------------------------------------------
    protected StickyListHeadersListView list_V;
