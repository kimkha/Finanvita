...
import com.kimkha.finance.api.CurrencyAPI;
import com.kimkha.finance.api.Finanvita;
...
public class CurrenciesRestService extends AbstractService
{
    ...
    private double getExchangeRate(String from, String to) throws Exception
    {
        ...
        return new JSONObject(Finanvita.parseResponseBody(response)).getDouble("rate");
    }
