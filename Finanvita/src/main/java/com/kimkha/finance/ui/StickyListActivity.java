...
public abstract class StickyListActivity extends BaseActivity
{
    // -----------------------------------------------------------------------------------------------------------------
    protected static final String EXTRA_SELECTION_TYPE = StickyListActivity.class.getName() + ".EXTRA_SELECTION_TYPE";
    protected static final String EXTRA_ITEM_IDS = StickyListActivity.class.getName() + ".EXTRA_ITEM_IDS";
    // -----------------------------------------------------------------------------------------------------------------
    protected static final String FRAGMENT_LIST = "FRAGMENT_LIST";
    // -----------------------------------------------------------------------------------------------------------------
    protected StickyListFragment list_F;
    // -----------------------------------------------------------------------------------------------------------------
    ...
    /**
     * Use this when creating an activity for item selection. {@link android.content.Intent} must be generated using {@link #makeIntent(android.content.Context, Class)}.
     *
    ...
    /**
     * Use this when creating an activity for item multi-selection. {@link android.content.Intent} must be generated using {@link #makeIntent(android.content.Context, Class)}.
     *
     * @param fragment    Fragment that requests an item.
     * @param intent      Intent to send.
     * @param requestCode Request code.
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        list_F = (StickyListFragment) fm.findFragmentByTag(FRAGMENT_LIST);
        if (list_F == null)
        {
     ...
     */
    protected abstract StickyListFragment createListFragment(int selectionType, long[] itemIDs);
