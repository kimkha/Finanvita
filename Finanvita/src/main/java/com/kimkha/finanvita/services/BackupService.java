...
import com.kimkha.finanvita.parsers.BackupParser;
import com.kimkha.finanvita.parsers.JTags;
...
import com.kimkha.finanvita.utils.StringUtils;
...
public class BackupService extends AbstractService
{
    ...
    private static final String ROOT_FOLDER_NAME = "Finanvita";
